...
const navItems = [
  ...
  { href: "/company-settings", label: "Company Settings", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" },
  { href: "/profile", label: "Profile", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
  { href: "/change-password", label: "Change Password", icon: "M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" },
];
      ...
      <div className="flex h-full flex-col">
        <div className="flex h-16 items-center justify-center border-b border-gray-200 px-4">
          <Link href="/dashboard" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-gray-900">InvoiceGen</span>
          </Link>
        </div>
        ...
        <nav className="flex-1 space-y-1 px-3 py-4">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                <svg
                  className={`h-5 w-5 flex-shrink-0 ${isActive ? "text-blue-700" : "text-gray-400"}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
